function validate0()
{
    ...
    if(document.getElementById('ordenado').value!='ordenado'){
		error++;
        errorMessage+="<p>La respuesta de 整齐 es errónea</p>";
        document.getElementById('ordenado').classList.add('errorInput');
    }
    else
    {
        if(document.getElementById('ordenado').classList.contains('errorInput'))
        {
            document.getElementById('ordenado').classList.remove('errorInput');
        }
    }
